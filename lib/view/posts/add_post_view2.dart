...
class AddPostView2 extends StatefulWidget {
  const AddPostView2({super.key});

  @override
  State<AddPostView2> createState() => _AddPostView2State();
}

class _AddPostView2State extends State<AddPostView2> {
